...
class PublisherMW ():
    ...
    def configure(self, args):
        ...
        try:
            ...
            self.logger.info(
                f"PublisherMW - {self.addr}:{self.port} Configured Successfully")
    ...
    def register(self, name, topiclist):
        ...
        try:
            ...
            register_req.initial_req=True
            # converts list into comma sep string
            ...
            self.logger.info(f"PublisherMW - Sent register request to Discovery")
    ...
    def is_ready(self):
        ...
        try:
            ...
            self.logger.info(
                f"PublisherMW - Sent is_ready request, waiting for reply...")
    ...
    def handle_reply(self):
        ...
        try:
            ...
            self.logger.info(
                f"PublisherMW - Received reply of type {disc_resp.msg_type}")
            ...
            if (disc_resp.msg_type == discovery_pb2.REGISTER):
                ...
                if self.lookup == 'DHT':
                    ...
                    self.topic_registered_count += 1
                    self.logger.info(
                        f'Received {self.topic_registered_count}/{self.num_topics} registration verifications')
    ...
    def disseminate(self, topic, content):
        try:
            self.logger.info(
                f"PublisherMW - Disseminating - {topic} {content}")
